...
(i) (3 + 4 + 5) / 3 = (3 + 4 + 5) / 3 = 12 / 3 = 4.0
(j) (3 + 4 + 5) // 3 = (3 + 4 + 5) // 3 = 12 // 3 = 4
...
(o) d1 + d2 + d3 / 3 = 2.0 + 5.0 + -0.5 / 3 = 2.0 + 5.0 - 0.16666666666666666 = 6.833333333333334
(p) (d1 + d2 + d3) / 3 = (2.0 + 5.0 + -0.5) / 3 = 6.5 / 3 = 2.1666666666666665
(q) d1 + d2 + (d3 / 3) = 2.0 + 5.0 + (-0.5 / 3) = 2.0 + 5.0 - 0.16666666666666666 = 6.833333333333334
